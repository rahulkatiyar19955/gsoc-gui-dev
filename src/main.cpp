...
/** \mainpage RoboComp::dataCapture
 *
 * \section intro_sec Introduction
 *
 * The dataCapture component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/dataCapture --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class dataCapture : public RoboComp::Application
{
public:
	dataCapture (QString prfx, bool startup_check) { prefix = prfx.toStdString(); this->startup_check_flag=startup_check; }
private:
	void initialize();
	std::string prefix;
	MapPrx mprx;
...
int ::dataCapture::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	::dataCapture app(prefix, startup_check_flag);
